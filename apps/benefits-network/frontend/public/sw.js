const CACHE_NAME = 'ifr-benefits-v6';
const PRECACHE_URLS = [
  '/',
  '/manifest.json',
  '/icons/ifr-official-64-v4.png',
  '/icons/ifr-official-180-v4.png',
  '/icons/ifr-official-192-v4.png',
  '/icons/ifr-official-256-v4.png',
  '/icons/ifr-official-512-v4.png',
