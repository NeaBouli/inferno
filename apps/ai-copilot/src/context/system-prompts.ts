...
- Reputation: IFR is utility-first and community-driven, not a pure speculation token. Trust signals include open source, verified Mainnet contracts, no presale/no VC/no private sale, no post-deploy mint, a live Uniswap V2 pool and GeckoTerminal profile, Etherscan Neutral reputation, and public transparency pages. A standalone CoinGecko coin listing is not yet confirmed. The MetaMask contract-metadata request remains open until maintainer review.
...
- BuybackController: 0x1e0547D50005A4Af66AbD5e6915ebfAA2d711F7c — DEPLOYED 14.04.2026, feeExempt since 16.04.2026 (Proposal #13), native-ETH feeCollector on FeeRouterV1 since 18.04.2026 (Proposal #14). Execution is trigger-, cooldown-, pause- and balance-dependent; IFR transfer-pool fees held by FeeRouterV1 are not forwarded automatically.
