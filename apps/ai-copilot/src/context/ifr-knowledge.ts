...
export function getIFRKnowledge() {
  ...
  return {
    audits: {
      status: "The seven Collateral Web3 Open Audits reports cover CWA-01 through CWA-82. At the 2026-09-20 remediation checkpoint, 29 findings are fixed and verified, 11 are governance or owner gated, 2 are accepted or monitored, 29 are open actionable, and 11 are informational.",
