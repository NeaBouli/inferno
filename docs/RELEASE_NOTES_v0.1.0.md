...
Inferno v0.1.0 marks the **first tagged release** of the protocol. All 14 smart contracts are deployed and verified on Sepolia testnet. The full application stack (8 apps) is operational. 436 tests pass across all components.

### What's Included

**14 Smart Contracts** — all deployed and verified on Sepolia:
