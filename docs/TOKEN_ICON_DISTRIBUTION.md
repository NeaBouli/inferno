...
| ethereum-lists | Replacement open / review pending | PR #1049 is open and `BLOCKED`: https://github.com/ethereum-lists/tokens/pull/1049. No submitted review, reported check or maintainer comment is present. Original PR #1036 was stale-closed and points to this single replacement. |
...
9. CoinGecko active listing request `CL0309260050` was submitted on
   2026-09-04 and is pending; do not submit a duplicate.
10. Run `npm run check:listing-status` for a reproducible read-only snapshot
