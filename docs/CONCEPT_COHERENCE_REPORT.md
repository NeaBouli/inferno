...
4. Open ecosystem (permissionless, no named partner)
...
|-------|-------------|--------|---------|
| 1 | No named partner | **PASS** | 0 matches in docs/apps/README (CLAUDE.md: only filename reference `securecall_logo.png # legacy`) |
