...
**Ticker:** $IFR
**Status:** Historical snapshot. Current verification uses full internal audits plus public automated test evidence; independent professional third-party audit pending.
...
Sepolia deployment served as the full testnet validation phase prior to mainnet. All contracts were deployed and verified on Sepolia before mainnet launch. See `docs/DEPLOYMENTS.md` for full Sepolia address list.
