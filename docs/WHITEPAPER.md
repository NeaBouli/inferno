...
- 578 tests (521 protocol + 57 ecosystem), all passing, 99% statement coverage
...
| Phase 1 — Launch | Complete | Mainnet deployed (2026-03-05), 16 on-chain components verified |
