...
│   ├── PROJECT-SUMMARY.md             Complete Overview (10 Contracts, 568 tests, 7 Apps, CI/CD)
...
| Solidity LOC | 1,950 |
| Tests | 521 protocol (367 contract + 27 BuilderRegistry + 77 app + 50 bootstrap) + 47 ecosystem (23 verify + 12 vote + 12 browser) = 568 total |
| Branch Coverage | 91% |
| Test LOC | 2,402 |
