...
2. If yes, should support be limited to measurable integration work or a returnable market-making mandate instead of an unrestricted listing fee?
3. Which source and ceiling should apply?
   • No incentive: 0 IFR
...
A transparent wallet-authenticated Council agenda and vote-log portal is also planned. It is not live and will not custody keys or execute Treasury transactions.

Full agenda and status:
