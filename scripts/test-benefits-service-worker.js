...
async function main() {
  ...
  assert(source.includes("const CACHE_NAME = 'ifr-benefits-v17'"), 'service worker cache version must be v17');
  ...
  assert(layoutSource.includes("'/sw.js?v=17'"), 'layout must register the current service-worker release');
