...
async function main() {
  ...
  assert(source.includes("const CACHE_NAME = 'ifr-benefits-v18'"), 'service worker cache version must be v18');
  ...
  assert(layoutSource.includes("'/sw.js?v=18'"), 'layout must register the current service-worker release');
