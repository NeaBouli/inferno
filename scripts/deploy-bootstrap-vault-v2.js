...
/**
 * INFERNO — Deploy BootstrapVaultV2 to Sepolia
 *
 ...
 *
 * Usage: npx hardhat run scripts/deploy-bootstrap-vault-v2.js --network sepolia
 */
...
async function main() {
  ...
  console.log("  INFERNO — Deploy BootstrapVaultV2");
  console.log("=".repeat(60));
