...
async function verifyHttpSurface() {
  ...
  assert(manifest.icons[0].src === '/icons/ifr-official-192-v4.png', 'manifest 192 icon mismatch');
  assert(manifest.icons[1].src === '/icons/ifr-official-512-v4.png', 'manifest 512 icon mismatch');
  ...
  await expectSha256('/icons/ifr-official-64-v4.png', '81b6502f5d9e8ccf610edbce49c8a28333edf3740fe1748fd39160d5fe8e4bf0');
  await expectSha256('/icons/ifr-official-180-v4.png', '66efa6b6551151367639f4f92eb9c9766b295b12c3792c2e65bf47a0a446af76');
  await expectSha256('/icons/ifr-official-192-v4.png', 'c2e06aa93d6ba47f30d0ccd14d2a8d9a16c04841e56cb7f4f2bb783e86fdf203');
  await expectSha256('/icons/ifr-official-256-v4.png', 'e16d4ed9e2fdd6907ad718e57700ae3931fbef1843a05f578413b08c947f3d48');
  await expectSha256('/icons/ifr-official-512-v4.png', '6f029513ff76f3482418da9792e6f9f3545f0cc18b88740fe1f61db50fbe87f1');
  await expectSha256('/icons/favicon-v4.ico', 'a3aed7b164e483413f361b08fbdd16465bc84a140109bdd552ec4e242f5c5d3c');
  ...
  await fetchOk('/icons/favicon-v4.ico', 'image/x-icon');
  await fetchOk('/favicon.ico', 'image/x-icon');
  const serviceWorker = await fetchOk('/sw.js', 'javascript');
  assert((await serviceWorker.text()).includes("ifr-benefits-v6"), 'service worker cache version mismatch');
  log('PWA assets OK');
...
async function verifyPage(contextOptions, label) {
  ...
  try {
    ...
    assert(
      await officialIcon.getAttribute('src') === '/icons/ifr-official-256-v4.png',
