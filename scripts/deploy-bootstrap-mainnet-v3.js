...
/**
 * INFERNO — Deploy BootstrapVaultV3 to Ethereum Mainnet
 *
 ...
 *   MAINNET:  npx hardhat run scripts/deploy-bootstrap-mainnet-v3.js --network mainnet
 */
...
async function main() {
  ...
  console.log("  INFERNO — Deploy BootstrapVaultV3 (Mainnet)");
  console.log("=".repeat(60));
